      ...
      <div className="flex flex-col md:items-center">
        <main className="prose text-sm md:text-base">
          ...
          <p>
            ...
            from HWZ Hochschule für Wirtschaft Zürich / HWZ University of
            Applied Sciences in Business Administration Zurich. Since 2019 I
            live in Berlin. Berlin has a vibrant tech scene and inspired me to
            get into code. I came here for my then-girlfriend now-wife. Since
          ...
          <ul className="simple-list">
            <li>
              <b>Code.</b> Software Engineering has become such a big thing in
              my life. It has been an incredible journey and I am very grateful
              that I can do what I do. Sometimes I find things that I do so
              interesting that I want to write about them and share them with
              the world. Sometimes I figure out things that might be useful for
              other people too. A recent example could be: "How can you
              authenticate to AWS ECR to register your docker images from GitLab
              CI?" Other ideas are reviewing online courses or pondering upon
            ...
            <li>
              ...
              meaningful? I have been thinking about these things since
              childhood, and perhaps I might write about these things as well.
            </li>
          </ul>
          <p>
            I am never exactly sure why of all people you should read me /
            listen to me. Who am I that I could tell you something about these
            things? I don't know. I want to avoid meaninglessness, redundancy,
            irrelevance and I truly want to bring value to those who take the
            time to listen. I regard this blog as an experiment, let's see where
            it leads.
          </p>
          <h3 className="gradient-text text-lg md:text-2xl font-light">
